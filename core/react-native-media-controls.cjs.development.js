...
var containerBackgroundColor = 'rgba(0, 0, 0, 0)';
...
var Controls = function Controls(props) {
  ...
  var pressAction =
    playerState === exports.PLAYER_STATES.ENDED ? onReplay : onPause;
  var content = isLoading
    ...
    : React__default.createElement(
        reactNative.TouchableOpacity,
        {
          ...
          onPress: pressAction,
          accessibilityLabel: exports.PLAYER_STATES.PAUSED
            ? 'Tap to Play'
            : 'Tap to Pause',
...
var Slider = function Slider(props) {
  ...
  var containerStyle =
    (customSliderStyle === null || customSliderStyle === void 0
      ? void 0
      : customSliderStyle.containerStyle) || {};
  var customTrackStyle =
    (customSliderStyle === null || customSliderStyle === void 0
      ? void 0
      : customSliderStyle.trackStyle) || {};
  var customThumbStyle =
    (customSliderStyle === null || customSliderStyle === void 0
      ? void 0
      : customSliderStyle.thumbStyle) || {};
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(RNSlider, {
...
var MediaControls = function MediaControls(props) {
  var children = props.children,
    ...
    customContainerStyle =
      _props$containerStyle === void 0 ? {} : _props$containerStyle,
    duration = props.duration,
    ...
    mainColor =
      _props$mainColor === void 0 ? 'rgba(0,0,0,0)' : _props$mainColor,
    onFullScreen = props.onFullScreen,
    ...
    customToolbarStyle =
      _props$toolbarStyle === void 0 ? {} : _props$toolbarStyle;
  ...
  var _useState = React.useState(
      new reactNative.Animated.Value(initialOpacity),
    ),
    opacity = _useState[0];
